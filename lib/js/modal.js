class ItcModal {
    ...
    try {
      ...
      const bitrixData = {
        fields: {
          ...
          TYPE_ID: "SALE",
          CATEGORY_ID: 0, // Воронка продажи (0)
          STAGE_ID: "NEW", // Новая заявка (NEW)
          ASSIGNED_BY_ID: 16, // Ответственный - Александра Поданева (16)
          CURRENCY_ID: "RUB",
          OPPORTUNITY: 0,
          SOURCE_ID: "WEB",
  ...
  setBody(html) {
    ...
    // После изменения body нужно заново настроить обработчики
