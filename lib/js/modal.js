class ItcModal {
  ...
  constructor(options = []) {
    ...
    html = html.replace('{{content}}', options.content || '<h1 class="modal__h1">Забронируйте</h1> <br> <p class="modal__p">Волшебный отдых в Хитром Лисе</p><form action="form"><div class="modal__form__input"><label>Ваше имя</label><input type="text" value="Введите имя"></div><div class="modal__form__input"><label>Ваш телефон</label><input type="tel" value="+7"></div><div class="modal__form__input"><label>Дата</label><input type="date" value="Дата праздника"></div><div class="modal__form__input"><label>Время</label><input type="text" value="10:00"></div><button class="modal__form-button">Отправить</button></form><span class="modal__span">Нажимая кнопку "ОСТАВИТЬ ЗАЯВКУ", вы соглашаетесь на <br>обработку своих персональных данных в соответствии с <br> <b><a href="/"> Политикой конфиденциальности</a></b></span>');
